...
export function ManageUser() {
    ...
    return (
        <>
            <Menu />
            <Container style={{ background: "#318F9B", width: "1312px", height: "300px", display: "flex", alignItems: "center" }}>
                <Container style={{ background: "white", width: "1312px", height: "227px", borderRadius: "32px" }}>
                    <Row >
                        <Col xs={4}>
                        ...
                        <Col>
                            <Row style={{ marginTop: "50px" }}>
                                <span style={{ fontWeight: "bold", fontSize: "22px" }}>Nguyen Van A</span>
                            </Row>
                            <Row>
            ...
            <Row>
                <Col xs={3}>
                <Card>
                    <Card.Img variant="top" src="./assets/frame7.png" style={{
                        width: "316px", height: "169px"
                    }} />
                </Card>
                </Col>
